...
const BGMIArena = () => {
    ...
    const tabs = [
        { id: 'live', label: 'Sector Active', icon: Flame },
        { id: 'completed', label: 'History', icon: CheckCircle },
    ]
    ...
    return (
        <div className="min-h-screen bg-[#0a0e1a] text-white pb-32 font-sans overflow-x-hidden">
            ...
            <div className="fixed inset-0 pointer-events-none">
                <div className="absolute top-0 right-1/4 w-[600px] h-[400px] bg-teal-500/5 blur-[120px]" />
                <div className="absolute bottom-1/4 left-0 w-[500px] h-[500px] bg-emerald-600/5 blur-[100px]" />
            </div>
            ...
            <div className="sticky top-0 z-50 bg-[#0a0e1a]/80 backdrop-blur-xl border-b border-white/5 p-4 flex items-center justify-between">
                ...
                <button
                    ...
                    className="w-10 h-10 rounded-xl bg-teal-500/10 flex items-center justify-center hover:bg-teal-500 transition-all border border-teal-500/20 group"
                >
                    <Plus size={18} className="text-teal-400 group-hover:text-black" />
                </button>
            </div>
            ...
            <div className="relative h-[45vh] md:h-[55vh] overflow-hidden group">
                ...
                <div className="absolute inset-0 z-20 flex flex-col items-center justify-center p-4">
                    ...
                    >
                        <h2 className="text-6xl md:text-9xl font-black italic tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-teal-400 via-emerald-500 to-green-600 drop-shadow-2xl">
                            MASTERS<span className="text-white">.</span>
                        </h2>
                        <span className="text-[10px] md:text-xs font-black text-white/50 uppercase tracking-[0.8em] block">Elite Competition Ground</span>
                    </motion.div>
                </div>
            </div>
                ...
                <motion.div layout className="min-h-[500px]">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-40 gap-6">
                            <div className="w-16 h-16 border-2 border-teal-500/10 border-t-teal-500 rounded-full animate-spin" />
                            <p className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.5em]">Fetching Sector Streams...</p>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center py-40 text-center bg-white/5 rounded-[2.5rem] border border-dashed border-white/5">
                            <h3 className="text-2xl font-black text-white italic mb-3 tracking-tighter uppercase">No Live Deployments</h3>
                            <p className="text-zinc-600 text-[10px] font-black uppercase tracking-[0.2em]">The sector is currently quiet. Await briefing.</p>
                        </div>
                    )}
                </motion.div>
            </div>
